...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  1 14:11:04 2019
...
#%%
   # 'card1__hour','card2__hour','card3__hour',
  #             'card5__hour','addr1__hour','TransactionAmt_decimal__hour'
 # 'month__card1','month__card2', 'month__card3','month__card5', 'TransactionAmt__hour'
for feature in ['TransactionAmt_decimal__addr2']:
   ...
   #%%
X=X.drop(columns=['month__card1'])
X['TransactionAmt_decimal__addr2']=train['TransactionAmt_decimal__addr2']
#%%
y = train['isFraud']
X = pd.DataFrame()
col=['TransactionDT','ProductCD','P_emaildomain','R_emaildomain','nulls','month','hour',
    ...
    'id_01', 'id_02', 'id_03', 'id_05', 'id_06', 'id_09','id_11', 'id_12', 'id_13', 'id_14', 'id_15',
    'id_17', 'id_19', 'id_20', 'id_30', 'id_31', 'id_32', 'id_33','id_36', 'id_37', 'id_38', 
   'V145',
...
#  'TransactionAmt_to_mean_card1','id_02_to_mean_card1','id_02_to_std_card4','D15_to_std_card1','id_02__id_20', 
#    'D11__DeviceInfo','P_emaildomain__C2','P_emaildomain_bin','R_emaildomain_bin',
...
X=X.drop(columns=['ProductCD','P_emaildomain','R_emaildomain','M4','M5','M6','M1', 
                  'M2','M3','M7','M8','M9','card6', 'DeviceType','card4',
                  'id_02','id_19','id_20','id_17',  'id_12', 'id_15', 'id_30','id_31','id_33', 'id_36', 'id_37', 'id_38',
                  'C2','TransactionDT','addr2','D6','D13','C5','C9','D7','C14',
                'uid','uid2','uid3'
                 ])
...
def addfeature(var):
    ...
    col=['TransactionDT','ProductCD','P_emaildomain','R_emaildomain','nulls','month','hour',
       ...
       'V145',
        ...
        'V277', 'V278', 'V279', 'V280', 'V282', 'V283', 'V285', 'V287', 'V288', 'V289', 'V291', 'V292', 'V294', 'V303',
        'V304', 'V306', 'V307', 'V308', 'V310', 'V312', 'V313', 'V314', 'V315', 'V317', 'V322', 
        'V323','V324', 'V326','V329','V331','V332', 'V333', 'V335', 'V336']+[var]
    ...
    #'TransactionAmt_to_mean_card1','TransactionAmt_to_mean_card4','TransactionAmt_to_std_card1',
    #'TransactionAmt_to_std_card4','id_02_to_mean_card1','id_02_to_mean_card4','id_02_to_std_card1','id_02_to_std_card4',
    #'D15_to_mean_card1','D15_to_mean_card4','D15_to_std_card1','D15_to_std_card4','D15_to_mean_addr1','D15_to_std_addr1',
    #'id_02__id_20', 'id_02__D8', 'D11__DeviceInfo', 'DeviceInfo__P_emaildomain', 'P_emaildomain__C2', 
    #                'card2__dist1', 'card1__card5', 'card2__id_20', 'card5__P_emaildomain', 'addr1__card1',
    #  'P_emaildomain_bin','R_emaildomain_bin','P_emaildomain_suffix','R_emaildomain_suffix',
    #'device_name','device_version','OS_id_30','version_id_30','browser_id_31','version_id_31',
    #     'screen_width','screen_height', 'id_34','id_23',
    #     
    #     
    #'V48','V53','V96','V338'
    #month is important
...
##     'V277', 'V278', 'V279', 'V280', 'V282', 'V283', 'V285', 'V287', 'V288', 'V289', 'V291', 'V292', 'V294', 'V303',
##     'V304', 'V306', 'V307', 'V308', 'V310', 'V312', 'V313', 'V314', 'V315', 'V317', 'V322']
#ls=[ 'id_12', 'id_15', 'id_30','id_31','id_33', 'id_36', 'id_37', 'id_38']
#ls=['device_name','device_version','OS_id_30','version_id_30','browser_id_31','version_id_31',
#    'screen_width','screen_height','id_34','id_23',]


ls=['TransactionAmt_decimal__TransactionDT','card1__hour','card2__hour','card3__hour',
               'card5__hour','addr1__hour','TransactionAmt_decimal__hour']
for i in ls:
...
#X['M4']=train['M4']
sns.scatterplot(data=train, x="V1", y="V2",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);    
#%%
plt.figure(figsize=(12, 7))
sns.scatterplot(data=train, x="TransactionDT", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);    
#%%
sns.scatterplot(data=X, x="card1", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  
                
#%%
sns.scatterplot(data=X, x="card2", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  
#%%
sns.scatterplot(data=X, x="card3", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  

#%%
sns.scatterplot(data=X, x="card5", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  

#%%
sns.scatterplot(data=X, x="addr1", y="TransactionAmt_decimal",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);        
...
sns.scatterplot(data=X, x="card1", y="hour",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  
                
#%%
plt.figure(figsize=(10, 4))
sns.scatterplot(data=X, x="card2", y="hour",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  
#%%
plt.figure(figsize=(10, 4))
sns.scatterplot(data=X, x="card3", y="hour",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  

#%%
plt.figure(figsize=(10, 4))
sns.scatterplot(data=X, x="card5", y="hour",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);  

#%%
plt.figure(figsize=(10, 4))
sns.scatterplot(data=X, x="addr1", y="hour",  s=10, alpha=1, 
                edgecolor="none", 
                hue='isFraud',palette=['orange','blue']);   
#%%
...
#test.shape
output.to_csv("output_submission_kf_fillna_fe.csv",index=False)
